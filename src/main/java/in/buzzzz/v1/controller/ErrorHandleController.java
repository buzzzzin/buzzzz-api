...
//    public ResponseDto error(@RequestHeader(value = "Accept-Language", defaultValue = "UK") String locale,Exception e) {
//        return prepareErrorResponseService.handleError(e,locale);
//    }
//
//    @Override
